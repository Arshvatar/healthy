...
<fieldset>
	<legend>Hast du das Gefühl, zu wenig, genügend oder viel zu viel zusätzliche körperliche Aktivitäten zu betreiben? </legend>
	<form action="seite6.php" id="form1" name="form1" method="POST" onsubmit="return validateQuestion('slider', '')">
        ...
        <div class="mx-0 w-100">
            ...
            <label for="customRange3" class="form-label"><h1>viel zu wenig - gerade richtig - viel zu viel</h1></label>
